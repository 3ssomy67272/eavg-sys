        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <ScrollReveal animation="slide-up" delay={300}>
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="https://community.infiniteflight.com/t/from-pyramids-to-the-world-egyptair-virtual-group-2026-official-thread" className="text-white/80 hover:text-white transition-colors">
                    IFC Thread
                  </a>
                </li>
                <li>
